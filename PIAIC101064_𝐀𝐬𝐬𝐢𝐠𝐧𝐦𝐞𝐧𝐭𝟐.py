...
def function2():
    ...
    x = np.arange(start=10, stop=37, step=1,dtype=np.float64).reshape(3,3,3)
...
def function5():
    ...
    z = np.zeros(shape=(4,5), dtype=int)
...
n = x.shape
arr = np.zeros(shape=(n), dtype=int)
return arr
...
def function9():
    ...
    a = np.arange(1, 101)
    x = a[a%2==0] #wrtie your code here
    return x
    """
    Expected Output:
...
def function17():
    ...
    #arr = np.where((arr%3==1) & (arr%3==1), 'NO', arr )
    #return np.where((arr%3==0) & (arr%5==0), 'YES', arr) # Write Your Code HERE
   # return np.where((arr%3==0) & (arr%5==0), 'YES', np.where((arr%3==1) & (arr%3==1), 'NO', np.where((arr%3==0) | (arr%11==0), 'NO', np.where((arr%2==0) | (arr%5==0), 'NO', arr ) ) )) # Write Your Code HERE
    return     np.where((arr%3==0) & (arr%5==0), 'YES', np.where((arr) , 'NO',arr) ) # Write Your Code HERE

#    return np.where((arr%3==0) & (arr%5==0), 'YES', arr) 

    #   (np.where((arr%3==1) & (arr%3==1), 'NO',arr)
    #Excpected Out
    """
